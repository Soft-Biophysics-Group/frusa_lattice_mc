...
def plot_cube_from_site_orientation(
    site_index: int, orientation: int, lx: int, ly: int, path_to_cube
):
    ...
    plot_cube(site_coords, euler_angles, path_to_cube)
    return
...
def plot_cubes_from_simulation_results(
    ...
    for site in full_sites:
        ...
        plot_cube_from_site_orientation(site, orientation, lx, ly, path_to_cube)
