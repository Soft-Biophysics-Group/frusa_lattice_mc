...
from plotting.plot_chain import plot_chain
from subprocess import run
import matplotlib.pyplot as plt


def sanity_check_tri(couplings):
...
# For chain
    model_params["couplings"] = cu.flatten_couplings(couplings)
...
# Options:
    ...
    moves_dict = {}
    # moves_dict["swap_empty_full"] = 1/2
    # moves_dict["rotate"] = 1/2
    moves_dict["rotate_and_swap_w_empty"] = 1
