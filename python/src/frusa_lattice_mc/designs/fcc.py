...
from ..geometry.particle_geometry import FccParticle

CRYSTAL_CONTACTS = FccParticle().get_all_canonical_contacts(
    [(2 * i, (2 * i + 12) % 24) for i in range(6)]
)

RED_MINUS_FACES = [10, 11, 12, 13, 16, 17, 20, 21]
ORTHOGONAL_RED_FACES = [2, 3, 6, 7, 14, 15, 18, 19]
HEDGEHOG_CONTACTS = FccParticle().get_all_canonical_contacts([
    (face_1, face_2)
...
SEED_CORNER = FccParticle().get_all_canonical_contacts(
    [
        (10, 11),
        (10, 21),
        (10, 12),
...
CRYSTAL_INTS_CORNER = FccParticle().get_all_canonical_contacts(
    [
        (0, 21),
        (0, 12),
        (0, 17),
...
SEED_HOLE_INTS_CORNER = FccParticle().get_all_canonical_contacts(
    [
        (2, 10),
        (2, 11),
        (2, 12),
