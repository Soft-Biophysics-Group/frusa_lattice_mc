...
#
#
# def load_cube(path_to_cube: Path | str = path_to_numbered_cube):
#     bpy.ops.file.pack_all()
#     bpy.ops.wm.obj_import(filepath=str(path_to_cube))
#     cube = bpy.context.selected_objects[0]
#     original_materials = list(cube.data.materials)
    #
    # return cube, original_materials
#
#
# def duplicate_shift_rotate_cube(
#     cube,
#     original_materials,
#     coords=[0.0, 0.0, 0.0],
...
#     collection = get_or_create_collection(collection_name)
    ...
    #
    # cube_copy.location = coords
    # new_rotation_euler = mathutils.Euler(euler_angles_xyz)
    # cube_copy.rotation_euler.rotate(new_rotation_euler)
    #
    # cube_copy.data.materials.clear()
    # for mat in original_materials:
    #     cube_copy.data.materials.append(mat)  # Assign each material
    #
    # collection.objects.link(cube_copy)
    #
    # return cube
#
#
# def place_cube_copy_from_site_orientation(
#     cube, original_materials, site_index: int, orientation: int, lx: int, ly: int
# ):
...
#     euler_angles = rotation.as_euler("xyz")
    #
    # duplicate_shift_rotate_cube(cube, original_materials, site_coords, euler_angles)
    #
    # return
#
#
...
#     full_sites = cfg.get_full_sites(results)
    #
    # original_cube, original_materials = load_cube(path_to_cube)
    #
    # for site in full_sites:
    #     orientation = orientations[site]
    #     place_cube_copy_from_site_orientation(
    #         original_cube, original_materials, site, orientation, lx, ly
    #     )
    #
    # if fig_file:
    ...
    # bpy.data.objects.remove(original_cube, do_unlink=True)
    #
    # return
#
#
